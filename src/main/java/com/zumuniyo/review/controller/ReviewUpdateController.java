...
public class ReviewUpdateController implements Command {

	@Override
	public String execute(HttpServletRequest request) {
		// 매장관리자의 추천리뷰로 등록하기 위한 페이지
		
		
		System.out.println("ReviewUpdateController");
		...
		if((request.getParameter("review_seq")==null)||(request.getParameter("review_exposure")==null)) {
			...
			//if(result<=0) { return "json:추천리뷰 등록실패"; }else {return "json:추천리뷰 등록성공"; }			 
			
			return "/review/SelectShopReviewJSP.do";
